        ...
        {updatedVariables.map((variable, index) => (
          <div className="mb-4" key={index}>
            ...
            <textarea
              ...
              className="mt-1 w-full rounded-lg border border-neutral-300 px-4 py-2 text-neutral-900 shadow focus:outline-none dark:border-[#1b2a4a] dark:bg-[#0f1d35] dark:text-neutral-100"
              style={{ resize: 'none' }}
